...
var Game = {
    ...
    preload : function() {
        ...
        game.load.image('snake', '/image/snake.png');
        game.load.image('apple', '/image/apple.png');
    },
    ...
    create : function() {
        ...
        // Speed.
        game.add.text(1200, 20, "SPEED", textStyle_Key);
    ...
    wallCollision: function(head) {
        ...
        if(head.x >= 1350 || head.x < 0 || head.y >= 600 || head.y < 0){
